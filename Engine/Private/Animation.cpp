...
CAnimation::CAnimation(const CAnimation& Proto)
	: m_fDuration{ Proto.m_fDuration }
	, m_fTickPerSecond{ Proto.m_fTickPerSecond }
	, m_iNumChannels{ Proto.m_iNumChannels }
	, m_Channels{ Proto.m_Channels }
	, m_iChannelKeyFrameIndices{ Proto.m_iChannelKeyFrameIndices }
{
