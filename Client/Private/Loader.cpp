...
#pragma region Map
    ...
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Proto GameObject Door_aniObj"), CDOOR::Create(m_pDevice, m_pContext));});
       
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Proto GameObject Chest_aniObj"),CCHEST::Create(m_pDevice, m_pContext));});

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype GameObject_WALL"),CWall::Create(m_pDevice, m_pContext));});
...
#pragma region Camera
    ...
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Camera_Free"),CCamera_Free::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_SceneCamera"),CSceneCamera::Create(m_pDevice, m_pContext));});
  
#pragma endregion
	
#pragma region BoomBot

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_BoomBot"),CBoomBot::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_BoomBot"),CBody_BoomBot::Create(m_pDevice, m_pContext));});

#pragma endregion

#pragma region MecanoBot

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_MecanoBot"),CMecanoBot::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_MecanoBot"),CBody_MecanoBot::Create(m_pDevice, m_pContext));});

#pragma endregion

#pragma region JetFly

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_JetFly"), CJetFly::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_JetFly"),CBody_JetFly::Create(m_pDevice, m_pContext));});
   
#pragma endregion

#pragma region GunPawn

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_GunPawn"),CGunPawn::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_GunPawn"),CBody_GunPawn::Create(m_pDevice, m_pContext));});
 
#pragma endregion

#pragma region HealthBot

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_HealthBot"),CHealthBot::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_HealthBot"),CBody_HealthBot::Create(m_pDevice, m_pContext));});
  
#pragma endregion

#pragma region BillyBoom

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_BillyBoom"),CBillyBoom::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_BillyBoom"),CBody_BillyBoom::Create(m_pDevice, m_pContext));});

#pragma endregion

#pragma region Player 

    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Player"),CPlayer::Create(m_pDevice, m_pContext));});
	
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Body_Player"),CBody_Player::Create(m_pDevice, m_pContext));});
...
#pragma region Skill
    ...
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_ShockWave"),CShockWave::Create(m_pDevice, m_pContext));});
...
#pragma region UI
   if (FAILED(m_pGameInstance->Add_UI_To_Proto(TEXT("Prototype_Gameobject_Pade"), CFade::Create(m_pDevice, m_pContext))))
       return E_FAIL;
   ...
   if (FAILED(m_pGameInstance->Add_UI_To_Proto(TEXT("Prototype_GameObject_PlayerHP_UI"),CPlayer_HpUI::Create(m_pDevice, m_pContext))))
       return E_FAIL;
   ...
   if (FAILED(m_pGameInstance->Add_UI_To_Proto(TEXT("Prototype GameObject_ShootingUI"),CPlayer_ShootingStateUI::Create(m_pDevice, m_pContext))))
       return E_FAIL;

   if (FAILED(m_pGameInstance->Add_UI_To_Proto(TEXT("Prototype GameObject_PlayerEffectUI"),CPlayer_StateUI::Create(m_pDevice, m_pContext))))
       return E_FAIL;
...
HRESULT CLoader::Loading_For_Sound()
{
    ...
    /*LODING*/
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Music_Credits.wav"); });
    /*interect*/
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Door_Act1_Open.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Door_Act1_Close.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Door_Boss_Act1_Open.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Door_Special_Open.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Door_Special_Airlock_Open.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Healbot_Use_09_15_2023.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Chest_Open.ogg"); });
    /*Player*/
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Stun_Loop.wav"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Footstep_Scuff_Sand.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Footstep_Scuff_Sand_05.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Switch_T01.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Jump.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_DoubleJump.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Burn_Loop.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Burn_Trigger.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Burn_Stop.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Player_Flash_Stop.ogg"); });
    /*WeaPon*/
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Handgun_Reload.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Handgun_PF_Shoot.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_AssaultRifle_Reload.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_AssaultRifle_PF_Shoot.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_HeavyCrossbow_Reload.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_HeavyCrossbow_SF_Shoot_A.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_MissileGatling_Reload.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_MissileGatling_PF_Shoot.ogg"); });
    /*Boss*/
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_Outro.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_Hand_Blast_Shoot.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_Shockwave_Shoot.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Laser_Loop.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Laser_Loop_Start.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Laser_Loop_Stop.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_FootStep.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_From_Two_Blaster_To_One.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_DiggyMole_Shockwave.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_Cast_Hand_Blast.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_BillyBoom_Presence.ogg"); });
    /*Enemy*/
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Step_Medium.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_MortarPod_Shoot.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Rocket_Shoot.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_FlashFly_Shoot_A.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Move_Roll.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Move_Roll2.ogg"); });
    m_pGameInstance->Add_Job([this]() { m_pGameInstance->LoadSoundFile("ST_Enemy_Move_Fly_Loop.ogg");});
    return S_OK;
}
...
#pragma region Shader
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxPosTex"),
                          CShader::Create(m_pDevice, m_pContext,TEXT("../Bin/ShaderFiles/Shader_VtxPosTex.hlsl"),VTXPOSTEX::Elements, VTXPOSTEX::iNumElements));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxPosTex_Inverse"),
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxMesh"),
                          CShader::Create(m_pDevice, m_pContext,TEXT("../Bin/ShaderFiles/Shader_VtxMesh.hlsl"),VTXMESH::Elements, VTXMESH::iNumElements));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxMeshIst"),
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxNorTex"),
                          CShader::Create(m_pDevice, m_pContext,TEXT("../Bin/ShaderFiles/Shader_VtxNorTex.hlsl"),VTXNORTEX::Elements, VTXNORTEX::iNumElements));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxAnimMesh"),
                          CShader::Create(m_pDevice, m_pContext,TEXT("../Bin/ShaderFiles/Shader_VtxAnimMesh.hlsl"),VTXANIMMESH::Elements, VTXANIMMESH::iNumElements));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxCube"),
                          CShader::Create(m_pDevice, m_pContext,TEXT("../Bin/ShaderFiles/Shader_VtxCube.hlsl"),VTXCUBE::Elements, VTXCUBE::iNumElements));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_Particle_Rect"),
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_Shader_Particle_Point"),
...
#pragma region Buffer
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Rect"),CVIBuffer_Rect::Create(m_pDevice, m_pContext));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_VIBufferPoint"),CVIBuffer_Point::Create(m_pDevice, m_pContext));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Cube"),CVIBuffer_Cube::Create(m_pDevice, m_pContext));});
...
#pragma region Collider
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Collider_AABB"),CCollider::Create(m_pDevice, m_pContext, CCollider::TYPE_AABB));});
   
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Collider_OBB"),CCollider::Create(m_pDevice, m_pContext, CCollider::TYPE_OBB));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Collider_SPHERE"),CCollider::Create(m_pDevice, m_pContext, CCollider::TYPE_SPHERE));});

#pragma endregion
  
#pragma region Player
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Player"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/Player.dat"),XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationY((XMConvertToRadians(180.f)))));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_HendGun"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/HendGun.dat"),XMMatrixIdentity()));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_AssaultRifle"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/AssaultRifle.dat"),XMMatrixIdentity()));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_MissileGatling"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/MissileGatling.dat"),XMMatrixIdentity()));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_HeavyCrossbow"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/HeavyCrossbow.dat"),XMMatrixIdentity()));});
#pragma endregion 

#pragma region Weapon
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto Component ChestWeapon Model_AssaultRifle_NonAni"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto Component ChestWeapon Model_MissileGatling_NonAni"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto Component ChestWeapon Model_HeavyCrossbow_NonAni"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
...
#pragma region Monster
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto_Component_GunPawn_Model"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/GunPawn.dat"),XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationY(XMConvertToRadians(180.f))));});
   
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto_Component_JetFly_Model"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/JetFly.dat"),XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationY(XMConvertToRadians(180.f))));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto_Component_BoomBot_Model"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/SKT_BoomBot.dat"),XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationY(XMConvertToRadians(180.f))));});
   
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_ComPonent_MecanoBot"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
                     TEXT("../Bin/Data/Ani/SKT_MecanoBot.dat"),XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationY(XMConvertToRadians(180.f))));});
  
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_ComPonent_BillyBoom"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Proto Component HealthBot_Model"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM,
...
{
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Player_HpBar"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/PlayerUI/PlayerHPBar%d.png"),3));});
		
	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Player_WeaPonTEX"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/PlayerUI/WeaPon%d.dds"),6));});

	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_KeyBoard_F"),
    ...
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Sky"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/SkyBox/Sky.dds")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_BusSmokeBack"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Bus/Back%d.png"), 20));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_BusSmokefront"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Bus/Front%d.png"), 20));});

	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Loading"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Loading/Loading.png")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_MonsterHP"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/MonsterHP/MonsterHP%d.dds"),2));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_ShootEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_VFX_Sprite-impact-spark_Gen2.dds")));});

	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Sprint"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_SprintLayer_3C.dds")));});
	
	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_UIEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/UIEffect.png")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_PrrrEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_Gen2_Rifle_PRRR_ga.dds")));});

	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_ClackEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_Gen2_Rifle_Clack.dds")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_TAAEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_Gen2_Rifle_TAA.dds")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_tAkAEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_JunkRifle_TAKA.dds")));});
     
    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Clack2Effect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_Gen1_Clack.dds")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_FlinkEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_Gen2_Flink.dds")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_TRAEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/T_Gen2_Rifle_TRA2.dds")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_spackEffect"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/Shooting/spack%d.png"),5));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_PlayerBullet"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/PlayerBullet0.png")));});

	m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_PlayerBulletBoom"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/PlayerBullet1.png")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_MonsterBullet"),
                    CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/MonsterBullet.png")));});

    m_pGameInstance->Add_Job([this](){ m_pGameInstance->Add_Prototype_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_ShockWaveEffect"),
...
#pragma region Model
        ...
        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Rock.dat"),PreTransformMatrix))))
            return E_FAIL;

        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock2 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Rock2.dat"),PreTransformMatrix))))
            return E_FAIL;

        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock3 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Rock3.dat"),PreTransformMatrix))))
            return E_FAIL;
        
        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock4 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Rock4.dat"),PreTransformMatrix))))
            return E_FAIL;

        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock5 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
        ...
        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock6 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Rock6.dat"), PreTransformMatrix))))
		    return E_FAIL;
	    
        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock7 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Rock7.dat"), PreTransformMatrix))))
		    return E_FAIL;

	    if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock8 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, 
            TEXT("../Bin/Data/NonAni/RocK8.dat"), PreTransformMatrix))))
		    return E_FAIL;

	    if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Arch3 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, 
            TEXT("../Bin/Data/NonAni/Arch3.dat"), PreTransformMatrix))))
		    return E_FAIL;

	    if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Arch2 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
            TEXT("../Bin/Data/NonAni/Arch2.dat"), PreTransformMatrix))))
		    return E_FAIL;

	    if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE1, TEXT("Proto Component Rock small wall1 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, 
...
#pragma region Model
         ...
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock2 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock2.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock3 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock3.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock4 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock4.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock5 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock5.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock6 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock6.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock7 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock7.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock8 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/RocK8.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Arch3 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Arch3.dat"),PreTransformMatrix))))
             return E_FAIL;
         
         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Arch2 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Arch2.dat"),PreTransformMatrix))))
             return E_FAIL;

         if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_STAGE2, TEXT("Proto Component Rock small wall1 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock_small_wall1.dat"),PreTransformMatrix))))
             return E_FAIL;
...
#pragma region Model
        ...
        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_BOSS, TEXT("Proto Component Rock small wall1 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Rock_small_wall1.dat"), PreTransformMatrix))))
            return E_FAIL;

        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_BOSS, TEXT("Proto Component Rock8 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/RocK8.dat"), PreTransformMatrix))))
            return E_FAIL;		
        
        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_BOSS, TEXT("Proto Component Arch3 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Arch3.dat"),PreTransformMatrix))))
            return E_FAIL;

        if (FAILED(m_pGameInstance->Add_Prototype_Component(LEVEL_BOSS, TEXT("Proto Component Arch2 Model_Wall"),CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM,
                   TEXT("../Bin/Data/NonAni/Arch2.dat"),PreTransformMatrix))))
            return E_FAIL;
