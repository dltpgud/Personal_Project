...
HRESULT CLevel_Loading::Ready_Clone_Layer(const _uint& pLayerTag)
{
	...
	Load.LoadingID = m_eLodingType;
  	...
  	if (FAILED(m_pGameInstance->Add_GameObject_To_Layer(LEVEL_LOADING, pLayerTag, L"Prototype_GameObject_Loading",nullptr, 0,&Load)))
		return E_FAIL;
...
CLevel_Loading * CLevel_Loading::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, LEVELID eNextLevelID, LOADINGID eLodingType)
{
