...
//	m_pGameInstance->Compute_Random(0.f, 10.f), 0.f, m_pGameInstance->Compute_Random(0.f, 10.f), 1.f));
...
HRESULT CAniObj::Add_Components()
{
	...
	/* For.Com_Shader */
	if (FAILED(__super::Add_Component(LEVEL_STAGE1, TEXT("Prototype_Component_Shader_VtxAnimMesh"),
